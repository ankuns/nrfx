...
if(IS_LINKER_TOOLCHAIN)
  set(STARTUP_FILE "gcc_startup_nrf7140_application.S")
elseif(IS_SCATTER_TOOLCHAIN)
  set(STARTUP_FILE "arm_startup_nrf7140_application.s")
endif()

set(SYSTEM_FILE "system_nrf71.c")
set(SVD_FILE    "nrf7140_applcation.svd")
...
if (NOT FLASH_START_ADDR)
  set(FLASH_START_ADDR 0x0E153000)
endif()
