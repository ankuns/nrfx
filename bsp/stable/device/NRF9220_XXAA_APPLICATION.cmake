...
if(IS_LINKER_TOOLCHAIN)
  set(STARTUP_FILE "gcc_startup_nrf9220_application.S")
elseif(IS_SCATTER_TOOLCHAIN)
  set(STARTUP_FILE "arm_startup_nrf9220_application.s")
endif()
...
if (NOT FLASH_START_ADDR)
  set(FLASH_START_ADDR 0x0E0A0000)
endif()
