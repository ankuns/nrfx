...
if(IS_LINKER_TOOLCHAIN)
  set(STARTUP_FILE "gcc_startup_nrf54l15_application.S")
elseif(IS_SCATTER_TOOLCHAIN)
  set(STARTUP_FILE "arm_startup_nrf54l15_application.s")
endif()

set(SYSTEM_FILE "system_nrf54l.c")
set(SVD_FILE    "nrf54l15_application.svd")

set(NORDIC_DEVICE "NRF54L15_XXAA")
