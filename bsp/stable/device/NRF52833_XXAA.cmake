...
if(IS_LINKER_TOOLCHAIN)
  set(STARTUP_FILE "gcc_startup_nrf52833.S")
elseif(IS_SCATTER_TOOLCHAIN)
  set(STARTUP_FILE "arm_startup_nrf52833.s")
endif()

set(SYSTEM_FILE "system_nrf52833.c")

set(NORDIC_DEVICE "NRF52833_XXAA")
